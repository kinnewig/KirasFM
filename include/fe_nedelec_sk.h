...
// For the computation of the face embedding:
...
class FE_NedelecSK : public FiniteElement<dim, dim>
{
public:
  static_assert(dim == spacedim,
                "FE_NedelecSK is only implemented for dim==spacedim!");
   ...
   */
  FE_NedelecSK(const unsigned int order);
